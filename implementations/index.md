...
* [Micronaut JSON:API](https://github.com/baylorpaul/micronaut-json-api) is a JSON:API library for Micronaut implementations. It includes mapping to/from entities, an `include` query parameter processor, an error response handler, and Page/Slice support.
